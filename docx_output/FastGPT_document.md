...
![](document/public/imgs/quizApp2.png)
...
| | |
| --- | --- |
| ![](document/public/imgs/image-83.png) | ![](document/public/imgs/image-84.png) |
...
| | | |
| --- | --- | --- |
| ![](document/public/imgs/image-85.png) | ![](document/public/imgs/image-86.png) | ![](document/public/imgs/image-87.png) |
...
![](document/public/imgs/quizApp1.png)
...
![](document/public/imgs/dataset3.png)
...
![](document/public/imgs/dataset4.png)
...
![](document/public/imgs/dataset1.png)

![](document/public/imgs/dataset2.png)
...
原始路径：`/docs/faq/external_channel_integration`
...
![](document/public/imgs/integration1.png)
...
原始路径：`/docs/faq/points_consumption`
...
![](document/public/imgs/points1.png)

---

## FastGPT 云服务

原始路径：`/docs/introduction/cloud`
...
原始路径：`/docs/introduction/commercial`
...
![alt text](document/public/imgs/image-58.png)

## 管理后台部分截图

|                                 |                                 |                                 |
| ------------------------------- | ------------------------------- | ------------------------------- |
| ![alt text](document/public/imgs/image-55.png) | ![alt text](document/public/imgs/image-56.png) | ![alt text](document/public/imgs/image-57.png) |

---

## 加入社区

原始路径：`/docs/introduction/development/community`
...
原始路径：`/docs/introduction/development/configuration`
...
原始路径：`/docs/introduction/development/custom-models/bge-rerank`
...
![](document/public/imgs/rerank1.png)
...
![alt text](document/public/imgs/image-102.png)
...
原始路径：`/docs/introduction/development/custom-models/chatglm2`
...
![](document/public/imgs/chatglm2.png)
...
![](document/public/imgs/model-m3e1.png)
...
原始路径：`/docs/introduction/development/custom-models/chatglm2-m3e`
...
1. 创建知识库时候选择 M3E 模型。
   ...
   ![](document/public/imgs/model-m3e2.png)
...
4. 应用绑定知识库
   ...
   ![](document/public/imgs/model-m3e4.png)
...
原始路径：`/docs/introduction/development/custom-models/m3e`
...
原始路径：`/docs/introduction/development/custom-models/marker`
...
![alt text](document/public/imgs/marker2.png)
...
![alt text](document/public/imgs/image-10.png)

同样的，在应用中，你可以在文件上传配置里，勾选上 `PDF 增强解析`。

![alt text](document/public/imgs/marker3.png)
...
|                                 |                                 |                                 |
| ------------------------------- | ------------------------------- | ------------------------------- |
| ![alt text](document/public/imgs/image-11.png) | ![alt text](document/public/imgs/image-12.png) | ![alt text](document/public/imgs/image-13.png) |
| ![alt text](document/public/imgs/image-14.png) | ![alt text](document/public/imgs/image-15.png) | ![alt text](document/public/imgs/image-16.png) |
...
原始路径：`/docs/introduction/development/custom-models/ollama`
...
![](document/public/imgs/Ollama-pull.png)
...
![](document/public/imgs/Ollama-models2.png)

![](document/public/imgs/Ollama-models3.png)
...
![](document/public/imgs/Ollama-aiproxy3.png)

在工作台中创建一个应用，选择自己之前添加的模型，此处模型名称为自己当时设置的别名。注：同一个模型无法多次添加，系统会采取最新添加时设置的别名。

![](document/public/imgs/Ollama-models4.png)
...
![](document/public/imgs/Ollama-oneapi1.png)

渠道添加成功后，点击令牌，点击添加令牌，填写名称，修改配置。

![](document/public/imgs/Ollama-oneapi2.png)
...
![](document/public/imgs/Ollama-oneapi3.png)
...
![](document/public/imgs/Ollama-direct1.png)
...
原始路径：`/docs/introduction/development/custom-models/xinference`
...
![](document/public/imgs/xinference-launch-model.png)
...
![](document/public/imgs/one-api-add-xinference-models.jpg)
...
## ![](document/public/imgs/fastgpt-list-models.png)
...
原始路径：`/docs/introduction/development/design/dataset`
...
原始路径：`/docs/introduction/development/design/design_plugin`
...
原始路径：`/docs/introduction/development/docker`
...
![](document/public/imgs/sealos-fastgpt.webp)
...
**选项集合：PgVector版本 / Oceanbase版本 / Milvus版本 / Zilliz版本**
...
![zilliz_key](document/public/imgs/zilliz_key.png)
...
原始路径：`/docs/introduction/development/faq`
...
![](document/public/imgs/faq2.png)

### 数据库3306端口被占用了，启动服务失败

![](document/public/imgs/faq3.png)
...
**选项集合：LLM模型 / Embedding模型 / Rerank 模型 / TTS 模型 / Whisper 模型**
...
原始路径：`/docs/introduction/development/intro`
...
原始路径：`/docs/introduction/development/migration/docker_db`
...
原始路径：`/docs/introduction/development/migration/docker_mongo`
...
原始路径：`/docs/introduction/development/modelConfig/ai-proxy`
...
![aiproxy12](document/public/imgs/aiproxy1.png)
...
![aiproxy1](document/public/imgs/aiproxy-1.png)

点击右上角的“新增渠道”，即可进入渠道配置页面

![aiproxy2](document/public/imgs/aiproxy-2.png)

以阿里云的模型为例，进行如下配置

![aiproxy3](document/public/imgs/aiproxy-3.png)
...
![aiproxy4](document/public/imgs/aiproxy-4.png)

### 2. 渠道测试

然后可以对渠道进行测试，确保配置的模型有效

![aiproxy5](document/public/imgs/aiproxy-5.png)

点击“模型测试”，可以看到配置的模型列表，点击“开始测试”

![aiproxy6](document/public/imgs/aiproxy-6.png)

等待模型测试完成后，会输出每个模型的测试结果以及请求时长

![aiproxy7](document/public/imgs/aiproxy-7.png)

### 3. 启用模型

最后在`模型配置`中，可以选择启用对应的模型，这样就能在平台中使用了，更多模型配置可以参考[模型配置](/docs/introduction/development/modelconfig/intro)

![aiproxy8](document/public/imgs/aiproxy-8.png)
...
原始路径：`/docs/introduction/development/modelConfig/intro`
...
![alt text](document/public/imgs/image-95.png)
...
|                                 |                                 |
| ------------------------------- | ------------------------------- |
| ![alt text](document/public/imgs/image-91.png) | ![alt text](document/public/imgs/image-92.png) |
...
|                                 |                                 |
| ------------------------------- | ------------------------------- |
| ![alt text](document/public/imgs/image-93.png) | ![alt text](document/public/imgs/image-94.png) |
...
|                                 |                                 |
| ------------------------------- | ------------------------------- |
| ![alt text](document/public/imgs/image-96.png) | ![alt text](document/public/imgs/image-97.png) |
...
|                                 |                                 |
| ------------------------------- | ------------------------------- |
| ![alt text](document/public/imgs/image-98.png) | ![alt text](document/public/imgs/image-99.png) |
...
![alt text](document/public/imgs/image-105.png)
...
![alt text](document/public/imgs/image-101.png)
...
![alt text](document/public/imgs/image-106.png)

填写硅基流动的地址：`https://api.siliconflow.cn/v1/audio/transcriptions`，并填写硅基流动的 API Key。

![alt text](document/public/imgs/image-107.png)
...
原始路径：`/docs/introduction/development/modelConfig/one-api`
...
![alt text](document/public/imgs/image-59.png)
...
![alt text](document/public/imgs/image-60.png)
...
![step5](document/public/imgs/oneapi-step5.png)

### 2. 创建渠道

在 One API 中添加对应渠道，直接点击 【添加基础模型】，不要遗漏了向量模型（Embedding）

![step6](document/public/imgs/oneapi-step6.png)

### 3. 创建令牌

| | |
| --- | --- |
| ![step7](document/public/imgs/oneapi-step7.png) | ![alt text](document/public/imgs/image-61.png) |

### 4. 修改账号余额

One API 默认 root 用户只有 200刀，可以自行修改编辑。

![alt text](document/public/imgs/image-62.png)
...
![](document/public/imgs/oneapi-demo1.png)

### 2. 修改 FastGPT 模型配置

打开 FastGPT 模型配置，启动文心千帆模型，如果希望未内置，可以通过新增模型来配置。

![alt text](document/public/imgs/image-103.png)
...
![alt text](document/public/imgs/image-63.png)
...
![alt text](document/public/imgs/image-64.png)
...
| | | |
| --- | --- | --- |
| ![alt text](document/public/imgs/image-65.png) | ![alt text](document/public/imgs/image-66.png)| ![alt text](document/public/imgs/image-67.png) |
...
原始路径：`/docs/introduction/development/modelConfig/ppio`
...
原始路径：`/docs/introduction/development/modelConfig/siliconCloud`
...
![alt text](document/public/imgs/image-104.png)
...
|                                 |                                 |
| ------------------------------- | ------------------------------- |
| ![alt text](document/public/imgs/image-68.png) | ![alt text](document/public/imgs/image-70.png) |
...
|                                 |                                 |
| ------------------------------- | ------------------------------- |
| ![alt text](document/public/imgs/image-72.png) | ![alt text](document/public/imgs/image-71.png) |
...
|                                 |                                 |                                 |
| ------------------------------- | ------------------------------- | ------------------------------- |
| ![alt text](document/public/imgs/image-73.png) | ![alt text](document/public/imgs/image-75.png) | ![alt text](document/public/imgs/image-76.png) |

对话完成后，点击底部的引用，可以查看引用详情，同时可以看到具体的检索和重排得分：

|                                 |                                 |
| ------------------------------- | ------------------------------- |
| ![alt text](document/public/imgs/image-77.png) | ![alt text](document/public/imgs/image-78.png) |

### 测试语音播放

继续在刚刚的应用中，左侧配置中找到语音播放，点击后可以从弹窗中选择语音模型，并进行试听：

![alt text](document/public/imgs/image-79.png)

### 测试语言输入

继续在刚刚的应用中，左侧配置中找到语音输入，点击后可以从弹窗中开启语言输入

![alt text](document/public/imgs/image-80.png)

开启后，对话输入框中，会增加一个话筒的图标，点击可进行语音输入：

|                                 |                                 |
| ------------------------------- | ------------------------------- |
| ![alt text](document/public/imgs/image-81.png) | ![alt text](document/public/imgs/image-82.png) |
...
原始路径：`/docs/introduction/development/openapi/chat`
...
![](document/public/imgs/appid.png)
...
**选项集合：detail=false,stream=false 响应 / detail=false,stream=true 响应 / detail=true,stream=false 响应 / detail=true,stream=true 响应 / event值**

**选项卡：detail=false,stream=false 响应**
...
**选项卡：detail=false,stream=true 响应**
...
**选项卡：detail=true,stream=false 响应**
...
**选项卡：detail=true,stream=true 响应**
...
**选项集合：detail=true,stream=false 响应 / detail=true,stream=true 响应 / 输出获取**
...
原始路径：`/docs/introduction/development/openapi/dataset`
...
| ----------------------------- | ----------------------------------- |
| ![](document/public/imgs/getDatasetId.jpg)   | ![](document/public/imgs/getfile_id.webp)          |
...
原始路径：`/docs/introduction/development/openapi/intro`
...
![](document/public/imgs/fastgpt-api-baseurl.png)
...
|        通用key               |           应用特定 key            |
| --------------------- | --------------------- |
| ![](document/public/imgs/fastgpt-api2.jpg) | ![](document/public/imgs/fastgpt-api1.jpg) |
...
原始路径：`/docs/introduction/development/openapi/share`
...
![](document/public/imgs/sharelink_process.png)

## 配置教程

### 1. 配置身份校验地址

![](document/public/imgs/share-setlink.png)
...
![](document/public/imgs/share-auth1.png)

**选项集合：/shareAuth/init / /shareAuth/start / /shareAuth/finish**
...
![](document/public/imgs/share-auth2.jpg)
...
原始路径：`/docs/introduction/development/proxy/cloudflare`
...
原始路径：`/docs/introduction/development/proxy/http_proxy`
...
原始路径：`/docs/introduction/development/proxy/nginx`
...
![](document/public/imgs/sealos3.webp)  
![](document/public/imgs/sealos4.png)

### 填写基本配置

务必开启外网访问，复制外网访问提供的地址。

![](document/public/imgs/sealos5.png)
...
6. 点击确认。
   ...
   ![](document/public/imgs/sealos6.png)
...
1. 进入刚刚部署应用的详情，复制外网地址
   ...
   ![](document/public/imgs/sealos7.png)
...
原始路径：`/docs/introduction/development/sealos`
...
![](document/public/imgs/onSealos1.png)
...
![](document/public/imgs/fastgptonsealos1.png)
...
![](document/public/imgs/onsealos2.png)
...
![](document/public/imgs/onsealos6.png)
...
![](document/public/imgs/onsealos7.png)

![](document/public/imgs/onsealos8.png)
...
原始路径：`/docs/introduction/guide/DialogBoxes/htmlRendering`
...
| 源码模式 | 预览模式 | 全屏模式 |
| --- | --- | --- |
| ![](document/public/imgs/htmlRendering1.png) | ![](document/public/imgs/htmlRendering2.png) | ![](document/public/imgs/htmlRendering3.png) |
...
原始路径：`/docs/introduction/guide/DialogBoxes/quoteList`
...
| 问题 | 引用 |
| --- | --- |
| ![](document/public/imgs/chunkReader1.png) | ![](document/public/imgs/chunkReader2.jpg) |

## FastGPT 分块阅读器：精准定位，无缝阅读

而在 FastGPT 全新的分块式阅读器中，同样的知识库内容和问题，呈现方式发生了质的飞跃

![](document/public/imgs/chunkReader4.jpg) 
...
![](document/public/imgs/chunkReader3.webp) 
...
![](document/public/imgs/chunkReader7.jpg)
...
|  |  |
| --- | --- |
| ![](document/public/imgs/chunkReader8.png) | ![](document/public/imgs/chunkReader9.jpg) |
...
原始路径：`/docs/introduction/guide/admin/sso`
...
<table className="table-hover table-striped-columns text-center">
  ...
  <tbody>
    <tr>
      <td>![企业微信](document/public/imgs/sso15.png)</td>
      <td>![钉钉](document/public/imgs/sso16.png)</td>
      <td>![飞书](document/public/imgs/sso17.png)</td>
    </tr>
  </tbody>
</table>
...
#### 1. 参数获取
   ...
   ![](document/public/imgs/sso3.png)

#### 2. 权限配置

   进入开发者后台，点击企业自建应用，在开发配置的权限管理页面开通权限。

   ![](document/public/imgs/sso4.png)
...
#### 1. 参数获取
   ...
   2. 创建一个供 FastGPT 使用的内部应用：
      ...
      ![](document/public/imgs/sso8.png)


      ![](document/public/imgs/sso9.png)
   ...
   3. 一个域名。并且要求：
      ...
      ![](document/public/imgs/sso10.png)

      ![](document/public/imgs/sso11.png)

      ![](document/public/imgs/sso12.png)
   ...
   4. 获取 "通讯录同步助手" secret
      ...
      ![](document/public/imgs/sso13.png)
   ...
   7. 配置企业可信 IP
      ...
      ![](document/public/imgs/sso14.png)
...
![](document/public/imgs/sso18.png)
...
原始路径：`/docs/introduction/guide/admin/teamMode`
...
原始路径：`/docs/introduction/guide/course/ai_settings`
...
|  |  | |
| --- | --- | --- |
| ![alt text](document/public/imgs/image-51.png) | ![alt text](document/public/imgs/image-52.png) | ![alt text](document/public/imgs/image-53.png) |
...
![alt text](document/public/imgs/image-54.png)
...
| 通用模板配置及效果 | 问答模板配置及效果 |
| --- | --- |
| ![](document/public/imgs/datasetprompt1.jpg) | ![](document/public/imgs/datasetprompt2.jpg) |
| ![](document/public/imgs/datasetprompt3.jpg) | ![](document/public/imgs/datasetprompt5.jpg) |
| ![](document/public/imgs/datasetprompt4.jpg) | ![](document/public/imgs/datasetprompt6.jpg) |
...
| --- | --- | --- |
| ![](document/public/imgs/datasetprompt7.webp) | ![](document/public/imgs/datasetprompt8.jpg) |![](document/public/imgs/datasetprompt9.jpg) |
...
原始路径：`/docs/introduction/guide/course/chat_input_guide`

> FastGPT 对话问题引导


![](document/public/imgs/questionGuide.png)
...
原始路径：`/docs/introduction/guide/course/fileInput`
...
![打开文件上传](document/public/imgs/fileinpu-1.png)

随后，你的调试对话框中，就会出现一个文件选择的 icon，可以点击文件选择 icon，选择你需要上传的文件。

![打开文件上传](document/public/imgs/fileinpu-2.png)
...
![打开文件上传](document/public/imgs/fileinpu-4.jpg)

在工作流中，使用文件的方式很多，最简单的就是类似下图中，直接通过工具调用接入文档解析，实现和简易模式一样的效果。

| | |
| --------------------- | --------------------- |
| ![](document/public/imgs/image-5.png) | ![](document/public/imgs/image-6.png) |

当然，你也可以在工作流中，对文档进行内容提取、内容分析等，然后将分析的结果传递给 HTTP 或者其他模块，从而实现文件处理的 SOP。

![文档解析](document/public/imgs/image-7.png)
...
原始路径：`/docs/introduction/guide/course/quick-start`
...
![](document/public/imgs/create-rep.png)
...
![](document/public/imgs/upload-data.png)

点击上传后我们需要等待数据处理完成，直到我们上传的文件状态为可用。

![](document/public/imgs/upload-data2.png)

## 应用

点击「应用」按钮来新建一个应用，这里有四个模板，我们选择「知识库 + 对话引导」。

![](document/public/imgs/create-app.png)

应用创建后来再应用详情页找到「知识库」模块，把我们刚刚创建的知识库添加进去。

![](document/public/imgs/create-app2.png)

添加完知识库后记得点击「保存并预览」，这样我们的应用就和知识库关联起来了。

![](document/public/imgs/create-app3.png)

然后我们就可以愉快的开始聊天啦。

![](document/public/imgs/create-app4.png)

---

## 简易模式

原始路径：`/docs/introduction/guide/dashboard/basic-mode`
...
原始路径：`/docs/introduction/guide/dashboard/evaluation`
...
![创建应用评测](document/public/imgs/evaluation1.png)

进入工作台下的应用评测目录，点击右上角的"创建任务"按钮。

### 填写评测信息

![创建应用评测](document/public/imgs/evaluation2.png)
...
![查看应用评测](document/public/imgs/evaluation4.png)
...
![查看应用评测](document/public/imgs/evaluation5.png)
...
原始路径：`/docs/introduction/guide/dashboard/gapier`
...
![](document/public/imgs/gapierToolResult1.webp)
...
| Step1 | Step2 | Step3 |
| --- | --- | --- |
| ![](document/public/imgs/gapierTool1.png) | ![](document/public/imgs/gapierTool2.png) | 登录[Gapier](https://gapier.com/) 复制相关参数 <br/> ![](document/public/imgs/gapierTool3.png) |
| Step4 | Step5 | Step6 |
| 自定义请求头: Authorization<br/>请求值: Bearer 复制的key <br/> ![](document/public/imgs/gapierTool4.png) | ![](document/public/imgs/gapierTool5.png) | ![](document/public/imgs/gapierTool6.png) |

创建完后，如果需要变更，无需重新创建，只需要修改对应参数即可，会自动做差值比较更新。

![](document/public/imgs/gapierTool7.png)
...
| Step1 | Step2 |
| --- | --- |
| ![](document/public/imgs/gapierTool8.png) | ![](document/public/imgs/gapierTool9.webp) |
| Step3 | Step4 |
| ![](document/public/imgs/gapierTool10.webp) | ![](document/public/imgs/gapierTool11.png) |

### 高级编排

| Step1 | Step2 |
| --- | --- |
| ![](document/public/imgs/gapierTool12.webp) | ![](document/public/imgs/gapierTool13.webp) |
| Step3 | Step4 |
| ![](document/public/imgs/gapierTool14.webp) | ![](document/public/imgs/gapierTool15.webp) |

![](document/public/imgs/gapierTool16.webp)
...
![](document/public/imgs/gapierTool17.webp)

---

## 工作流&插件

原始路径：`/docs/introduction/guide/dashboard/intro`
...
![](document/public/imgs/flow-intro1.png)
...
![](document/public/imgs/flow-intro2.png)
...
每个节点会包含 3 个核心部分：输入、输出和触发器。
   ...
   ![](document/public/imgs/flow-intro3.png)
...
原始路径：`/docs/introduction/guide/dashboard/mcp_server`
...
![创建 MCP server](document/public/imgs/mcp_server1.png)

可以自定义 MCP server 名称和选择关联的应用

| | |
|---|---|
| ![](document/public/imgs/mcp_server2.png) | ![](document/public/imgs/mcp_server3.png) |
...
| | |
|---|---|
| ![](document/public/imgs/mcp_server4.png) | ![](document/public/imgs/mcp_server5.png) |
...
| | | |
|---|---|---|
| ![](document/public/imgs/mcp_server6.png) | ![](document/public/imgs/mcp_server7.png) | ![](document/public/imgs/mcp_server8.png) |
...
| | |
|---|---|
| ![](document/public/imgs/mcp_server9.png) | ![](document/public/imgs/mcp_server10.png) |
...
原始路径：`/docs/introduction/guide/dashboard/mcp_tools`
...
![创建 MCP tools](document/public/imgs/mcp_tools1.png)
...
![测试 MCP tools](document/public/imgs/mcp_tools3.png)
...
![调用单个工具](document/public/imgs/mcp_tools4.png)

选中 maps_weather 和 maps_text_search 这两个工具为例，分别问 AI 两个问题，可以看到 AI 智能地调用了相应的工具获得了需要的信息，然后根据获得的信息回答

| | |
|---|---|
| ![](document/public/imgs/mcp_tools5.png) | ![](document/public/imgs/mcp_tools6.png) |
...
| | |
|---|---|
| ![](document/public/imgs/mcp_tools7.png) | ![](document/public/imgs/mcp_tools8.png) |
...
原始路径：`/docs/introduction/guide/dashboard/workflow/ai_chat`
...
![](document/public/imgs/aichat.png)
...
![](document/public/imgs/aichat02.png)

![](document/public/imgs/aichat2.png)
...
原始路径：`/docs/introduction/guide/dashboard/workflow/content_extract`
...
![](document/public/imgs/extract1.png)
...
原始路径：`/docs/introduction/guide/dashboard/workflow/coreferenceResolution`
...
![](document/public/imgs/coreferenceResolution1.jpg)
...
![](document/public/imgs/coreferenceResolution2.webp)
...
![](document/public/imgs/coreferenceResolution3.webp)
...
原始路径：`/docs/introduction/guide/dashboard/workflow/custom_feedback`
...
|                       |                       |
| --------------------- | --------------------- |
| ![](document/public/imgs/customfeedback1.jpg) | ![](document/public/imgs/customfeedback2.jpg) |
| ![](document/public/imgs/customfeedback3.jpg) | ![](document/public/imgs/customfeedback4.jpg) |
...
原始路径：`/docs/introduction/guide/dashboard/workflow/dataset_search`
...
![](document/public/imgs/flow-dataset1.png)
...
原始路径：`/docs/introduction/guide/dashboard/workflow/document_parsing`
...
| | |
| --- | --- |
| ![](document/public/imgs/document_analysis1.png) | ![](document/public/imgs/document_analysis2.png) |
...
原始路径：`/docs/introduction/guide/dashboard/workflow/form_input`
...
![](document/public/imgs/form_input1.png)

## 功能 

「表单输入」节点属于用户交互节点，当触发这个节点时，对话会进入“交互”状态，会记录工作流的状态，等用户完成交互后，继续向下执行工作流

![](document/public/imgs/form_input2.png)

比如上图中的例子，当触发表单输入节点时，对话框隐藏，对话进入“交互状态”

![](document/public/imgs/form_input3.png)
...
原始路径：`/docs/introduction/guide/dashboard/workflow/http`
...
![](document/public/imgs/http1.jpg)
...
**选项集合：假设有一组变量 / Http 模块中的Body声明 / 最终得到的解析**
...
原始路径：`/docs/introduction/guide/dashboard/workflow/knowledge_base_search_merge`

> FastGPT 知识库搜索引用合并模块介绍



![](document/public/imgs/knowledge_merge1.png)
...
![](document/public/imgs/knowledge_merge2.png)

使用**知识库搜索引用合并**，可以把多个知识库的搜索结果合在一起。

![](document/public/imgs/knowledge_merge3.png)
...
原始路径：`/docs/introduction/guide/dashboard/workflow/laf`

> FastGPT Laf 函数调用模块介绍



![](document/public/imgs/laf1.webp)
...
![](document/public/imgs/laf2.webp)
...
原始路径：`/docs/introduction/guide/dashboard/workflow/loop`
...
![批量运行节点](document/public/imgs/fastgpt-loop-node.png)
...
![循环体配置](document/public/imgs/fastgpt-loop-node-config.png)
...
1. 准备输入数组
   ...
   ![准备输入数组](document/public/imgs/fastgpt-loop-node-example-1.png)
...
2. 配置批量运行节点
   ...
   ![配置批量运行节点](document/public/imgs/fastgpt-loop-node-example-2.png)
...
![运行流程](document/public/imgs/fastgpt-loop-node-example-3.png)
...
1. 文本预处理与分段
   ...
   ![文本预处理与分段](document/public/imgs/fastgpt-loop-node-example-4.png)
...
2. 配置批量运行节点
   ...
   ![配置批量运行节点](document/public/imgs/fastgpt-loop-node-example-5.png)
...
原始路径：`/docs/introduction/guide/dashboard/workflow/question_classify`
...
原始路径：`/docs/introduction/guide/dashboard/workflow/reply`
...
![](document/public/imgs/specialreply.png)

---

## 代码运行

原始路径：`/docs/introduction/guide/dashboard/workflow/sandbox`

> FastGPT 代码运行节点介绍


![alt text](document/public/imgs/image.png)
...
![alt text](document/public/imgs/image-1.png)
...
![alt text](document/public/imgs/image-2.png)
...
原始路径：`/docs/introduction/guide/dashboard/workflow/text_editor`
...
![](document/public/imgs/string.png)
...
原始路径：`/docs/introduction/guide/dashboard/workflow/tfswitch`
...
![](document/public/imgs/judgement1.png)
...
原始路径：`/docs/introduction/guide/dashboard/workflow/tool`

> FastGPT 工具调用模块介绍



![](document/public/imgs/flow-tool1.png)
...
![](document/public/imgs/flow-tool2.png)
...
| | |
| --- | --- |
| ![](document/public/imgs/flow-tool3.png) | ![](document/public/imgs/flow-tool4.png) |
...
![](document/public/imgs/flow-tool5.png)
...
原始路径：`/docs/introduction/guide/dashboard/workflow/user-selection`
...
![](document/public/imgs/user-selection1.png)

## 功能 

「用户选择」节点属于用户交互节点，当触发这个节点时，对话会进入“交互”状态，会记录工作流的状态，等用户完成交互后，继续向下执行工作流

![](document/public/imgs/user-selection2.png)

比如上图中的例子，当触发用户选择节点时，对话框隐藏，对话进入“交互状态”

![](document/public/imgs/user-selection3.png)
...
原始路径：`/docs/introduction/guide/dashboard/workflow/variable_update`
...
![](document/public/imgs/variable_update1.png)

## 功能 

- 更新指定节点的输出值

![](document/public/imgs/variable_update2.png)

![](document/public/imgs/variable_update3.png)

- 更新全局变量

![](document/public/imgs/variable_update4.png)
...
原始路径：`/docs/introduction/guide/knowledge_base/RAG`
...
- 文本生成：RAG不仅可以检索相关文档，还能根据这些文档生成总结、报告或文档摘要，从而增强生成内容的连贯性和准确性。例如，法律领域中，RAG可以整合相关法条和判例，生成详细的法律意见书，确保内容的全面性和严谨性。这在法律咨询和文件生成过程中尤为重要，可以帮助律师和法律从业者提高工作效率。
  - [法律领域检索增强生成案例](https://www.apexon.com/blog/empowering-discovery-the-role-of-rag-architecture-generative-ai-in-healthcare-life-sciences/)
    ...
    - LegalBench-RAG 的结构：
      1. ![](document/public/imgs/RAG3.png)
      2.    工作流程：
...
原始路径：`/docs/introduction/guide/knowledge_base/api_dataset`
...
| | |
| --- | --- |
| ![](document/public/imgs/image-18.png) | ![](document/public/imgs/image-19.png) |
...
原始路径：`/docs/introduction/guide/knowledge_base/collection_tags`
...
|                       |                       | |
| --------------------- | --------------------- | --------------------- |
| ![](document/public/imgs/collection-tags-1.png) | ![](document/public/imgs/collection-tags-2.png) | ![](document/public/imgs/collection-tags-3.png) |
...
原始路径：`/docs/introduction/guide/knowledge_base/dataset_engine`
...
| | | |
| --- |---| --- |
|![](document/public/imgs/dataset_search_params1.png)| ![](document/public/imgs/dataset_search_params2.png) | ![](document/public/imgs/dataset_search_params3.png) |
...
原始路径：`/docs/introduction/guide/knowledge_base/lark_dataset`
...
| | |
| --- | --- |
| ![alt text](document/public/imgs/image-39.png) | ![alt text](document/public/imgs/image-40.png) |
...
![alt text](document/public/imgs/image-41.png)

## 3. 获取 appId 和 appSecret

![alt text](document/public/imgs/image-42.png)
...
![alt text](document/public/imgs/image-43.png)

## 5. 获取 Folder Token

可以页面路径上获取 Folder Token，注意不要把问号复制进来。

![alt text](document/public/imgs/image-44.png)

## 6. 创建知识库

根据 3 和 5 获取到的 3 个参数，创建知识库，选择飞书文件库类型，然后填入对应的参数，点击创建。

![alt text](document/public/imgs/image-39.png)

---

## 模板导入

原始路径：`/docs/introduction/guide/knowledge_base/template`

> FastGPT 模板导入功能介绍和使用方式
...
![](document/public/imgs/template/import.png)

![](document/public/imgs/template/box.png)
...
![](document/public/imgs/template/nomal.png)

对应 CSV 格式为

![](document/public/imgs/template/nomal_data.png)

常规模式下，q为内容，a为空，indexes可多个

#### 问答对的数据模版

![](document/public/imgs/template/Question-answer.png)

对应CSV格式为

![](document/public/imgs/template/Question-answer_data.png)
...
![](document/public/imgs/template/import_csv.png)
...
原始路径：`/docs/introduction/guide/knowledge_base/third_dataset`

> 本节详细介绍如何在FastGPT上自己接入第三方知识库
...
![](document/public/imgs/thirddataset-1.png)
...
![](document/public/imgs/thirddataset-3.png)

### 5. 添加知识库调用方法

在`FastGPT\packages\service\core\dataset\apiDataset\index.ts`文件下，添加如下内容。

![](document/public/imgs/thirddataset-4.png)
...
![](document/public/imgs/thirddataset-5.png)

`FastGPT\packages\service\support\user/audit\util.ts`文件下添加如下内容，以支持获取 I18n 翻译。

![](document/public/imgs/thirddataset-6.png)
...
![](document/public/imgs/thirddataset-11.png)

在`FastGPT\projects\app\src\pageComponents\dataset\detail\Info\index.tsx`文件下，添加如下内容。此处配置对应ui界面的如下。

| | |
| --- | --- |
![](document/public/imgs/thirddataset-12.png)|![](document/public/imgs/thirddataset-13.png)
...
| | | |
| --- | --- | --- |
| ![](document/public/imgs/thirddataset-14.png) | ![](document/public/imgs/thirddataset-15.png) | ![](document/public/imgs/thirddataset-16.png) |
...
| | |
| --- | --- | 
| ![](document/public/imgs/thirddataset-17.png) | ![](document/public/imgs/thirddataset-18.png) |
...
原始路径：`/docs/introduction/guide/knowledge_base/websync`

> FastGPT Web 站点同步功能介绍和使用方式


![](document/public/imgs/webSync1.jpg)
...
![](document/public/imgs/webSync2.jpg)

![](document/public/imgs/webSync3.jpg)
...
![](document/public/imgs/webSync5.jpg)

![](document/public/imgs/webSync5-1.jpg)

好了， 现在点击开始同步，静等系统自动抓取网站信息即可。

## 创建应用，绑定知识库

![](document/public/imgs/webSync6.jpg)
...
![](document/public/imgs/webSync7.webp)

![](document/public/imgs/webSync8.webp)
...
![](document/public/imgs/webSync9.webp)
...
![](document/public/imgs/webSync10.webp)
...
原始路径：`/docs/introduction/guide/knowledge_base/yuque_dataset`
...
| | |
| --- | --- |
| ![alt text](document/public/imgs/image-31.png) | ![alt text](document/public/imgs/image-32.png) |
...
![alt text](document/public/imgs/image-36.png)

参考下图获取 Token 和 User ID，注意给 Token 赋值权限：

| 获取 Token | 增加权限 | 获取 User ID |
| --- | --- | --- |
| ![alt text](document/public/imgs/image-33.png) | ![alt text](document/public/imgs/image-34.png) | ![alt text](document/public/imgs/image-35.png) |

## 2. 创建知识库

使用上一步获取的 token 和 uid，创建知识库，选择语雀文件库类型，然后填入对应的参数，点击创建。

![alt text](document/public/imgs/image-37.png)

![alt text](document/public/imgs/image-31.png)
...
![alt text](document/public/imgs/image-38.png)

---

## Bing 搜索插件填写说明

原始路径：`/docs/introduction/guide/plugins/bing_search_plugin`
...
![](document/public/imgs/bing_search_plugin1.png)
...
![](document/public/imgs/bing_search_plugin2.png)

1. # 进入资源详情点击管理密钥

![](document/public/imgs/bing_search_plugin3.png)

# 4. 复制任意一个密钥填入插件输入

![](document/public/imgs/bing_search_plugin4.png)

![](document/public/imgs/bing_search_plugin5.png)

---

## 如何开发系统工具

原始路径：`/docs/introduction/guide/plugins/dev_system_tool`
...
![](document/public/imgs/plugin-openapi.png)
...
原始路径：`/docs/introduction/guide/plugins/doc2x_plugin_guide`
...
![](document/public/imgs/doc2x_plugin1.png)

![](document/public/imgs/doc2x_plugin2.png)

1. # 填写apikey到fastgpt中

**工作流****中：**

![](document/public/imgs/doc2x_plugin3.png)

**简易模式使用：**

![](document/public/imgs/doc2x_plugin4.png)

---

## Google 搜索插件填写说明

原始路径：`/docs/introduction/guide/plugins/google_search_plugin_guide`
...
![](document/public/imgs/google_search_plugin1.png)

取得搜索引擎的ID，即cx

![](document/public/imgs/google_search_plugin2.png)

1. # 获取api key

https://developers.google.com/custom-search/v1/overview?hl=zh-cn

![](document/public/imgs/google_search_plugin3.png)

1. # 填入插件输入参数

将搜索引擎ID填入cx字段，api key填入key字段

![](document/public/imgs/google_search_plugin4.png)

---

## SearXNG 搜索插件配置与使用说明

原始路径：`/docs/introduction/guide/plugins/searxng_plugin_guide`
...
| 打开应用部署 | 点击新建应用 |
| --- | --- |
| ![](document/public/imgs/searxng_plugin_guide1.png) | ![alt text](document/public/imgs/image-45.png) |
...
![alt text](document/public/imgs/image-50.png)
...
| 复制公网地址| 填入 URL |
| --- | --- |
| ![alt text](document/public/imgs/image-48.png) | ![alt text](document/public/imgs/image-49.png) |
...
原始路径：`/docs/introduction/guide/team_permissions/invitation_link`
...
![](document/public/imgs/guide/team_permissions/invitation_link/image1.png)

2. **在邀请成员弹窗中，点击「创建邀请链接」按钮，创建邀请链接。**

![](document/public/imgs/guide/team_permissions/invitation_link/image2.png)

3. **输入对应内容**

![](document/public/imgs/guide/team_permissions/invitation_link/image3.png)
...
![](document/public/imgs/guide/team_permissions/invitation_link/image4.png)

5. **用户访问链接后，如果未登录/未注册，则先跳转到登录页面进行登录。在登录后将进入团队页面，处理邀请。**

> 邀请链接形如：fastgpt.cn/account/team?invitelinkid=xxxx

![](document/public/imgs/guide/team_permissions/invitation_link/image5.png)
...
原始路径：`/docs/introduction/guide/team_permissions/team_roles_permissions`
...
![](document/public/imgs/guide/team_permissions/team_roles_permissions/image1.jpeg)
...
![](document/public/imgs/guide/team_permissions/team_roles_permissions/image2.png)

管理团队权限时，需先选择成员/组织/群组，再进行权限配置。

![](document/public/imgs/guide/team_permissions/team_roles_permissions/image3.png)

对于应用和知识库等资源，可直接修改成员权限。

![](document/public/imgs/guide/team_permissions/team_roles_permissions/image4.png)

团队权限在专门的权限页面进行设置

![](document/public/imgs/guide/team_permissions/team_roles_permissions/image5.png)
...
|                       |                                   |
| --------------------- | --------------------------------- |
| ![](document/public/imgs/intro/image1.png) | ![](document/public/imgs/intro/image2.png) |
...
![](document/public/imgs/intro/image3.png)
...
![](document/public/imgs/intro/image5.png)

## 4. 工作流编排
基于 Flow 模块的工作流编排，可以帮助你设计更加复杂的问答流程。例如查询数据库、查询库存、预约实验室等。

![](document/public/imgs/intro/image6.png)

## 5. 强大的 API 集成
FastGPT 完全对齐 OpenAI 官方接口，支持一键接入企业微信、公众号、飞书、钉钉等平台，让 AI 能力轻松融入您的业务场景。

![](document/public/imgs/intro/image7.png)
...
![](document/public/imgs/intro/image8.png)

---

## 开源协议

原始路径：`/docs/protocol/open-source`
...
原始路径：`/docs/upgrading/4-10/4100`

> FastGPT V4.10.0 更新说明
...
![](document/public/imgs/sealos-s3.png)
...
原始路径：`/docs/upgrading/4-10/4101`

> FastGPT V4.10.1 更新说明
...
原始路径：`/docs/upgrading/4-11/4111`

> FastGPT V4.11.1 更新说明
...
原始路径：`/docs/upgrading/4-12/4120`

> FastGPT V4.12.0 更新说明, 发布于 2025-8-11
...
原始路径：`/docs/upgrading/4-12/4121`

> FastGPT V4.12.1 更新说明, 发布于 2025-8-18
...
原始路径：`/docs/upgrading/4-12/4122`

> FastGPT V4.12.2 更新说明, 发布于 2025-8-26
...
原始路径：`/docs/upgrading/4-12/4123`

> FastGPT V4.12.3 更新说明, 发布于 2025-9-8
...
原始路径：`/docs/upgrading/4-12/4124`

> FastGPT V4.12.4 更新说明, 发布于 2025-9-15
...
原始路径：`/docs/upgrading/4-8/447`

> FastGPT V4.4.7 更新（包含升级脚本）
...
|                      |                      |
| -------------------- | -------------------- |
| ![](document/public/imgs/v45-1.jpg) | ![](document/public/imgs/v45-2.jpg) |
| ![](document/public/imgs/v45-3.jpg) | ![](document/public/imgs/v45-4.jpg) |
...
| | |
| --- | --- |
| ![alt text](document/public/imgs/image-8.png) | ![alt text](document/public/imgs/image-9.png) |
...
|                                 |                                 |
| ------------------------------- | ------------------------------- |
| ![alt text](document/public/imgs/image-20.png) | ![alt text](document/public/imgs/image-21.png) |

### HTML 渲染

| 源码模式                        | 预览模式                        | 全屏模式                        |
| ------------------------------- | ------------------------------- | ------------------------------- |
| ![alt text](document/public/imgs/image-22.png) | ![alt text](document/public/imgs/image-23.png) | ![alt text](document/public/imgs/image-24.png) |
...
原始路径：`/docs/upgrading/4-9/4910`

> FastGPT V4.9.10 更新说明
...
原始路径：`/docs/upgrading/4-9/4912`

> FastGPT V4.9.12 更新说明
...
原始路径：`/docs/upgrading/4-9/4913`

> FastGPT V4.9.13 更新说明
...
原始路径：`/docs/upgrading/4-9/4914`

> FastGPT V4.9.14 更新说明
...
| | | |
| --- | --- |  --- |
| ![](document/public/imgs/sealos-redis1.png) | ![](document/public/imgs/sealos-redis2.png) |  ![](document/public/imgs/sealos-redis3.png) |
...
原始路径：`/docs/use-cases/app-cases/dalle3`
...
|                       |                       |
| --------------------- | --------------------- |
| ![](document/public/imgs/demo-dalle1.webp) | ![](document/public/imgs/demo-dalle2.webp) |
...
原始路径：`/docs/use-cases/app-cases/english_essay_correction_bot`
...
![](document/public/imgs/spellcheck1.png)
...
![](document/public/imgs/spellcheck2.png)
...
![](document/public/imgs/spellcheck3.png)

### 3. 数据处理

上面的大模型输出了一个 json，这里要进行数据处理。数据处理可以使用代码执行组件。

![](document/public/imgs/spellcheck4.png)
...
![](document/public/imgs/spellcheck5.png)
...
原始路径：`/docs/use-cases/app-cases/feishu_webhook`
...
|                       |                       |
| --------------------- | --------------------- |
| ![](document/public/imgs/feishuwebhook1.webp) | ![](document/public/imgs/feishuwebhook2.webp) |

## 1. 准备飞书机器人

|                       |                       | |
| --------------------- | --------------------- |--------------------- |
| ![](document/public/imgs/feishuwebhook3.png) | ![](document/public/imgs/feishuwebhook4.webp) |![](document/public/imgs/feishuwebhook5.png) |
...
原始路径：`/docs/use-cases/app-cases/fixingEvidence`

> 利用指定回复，创建固定的开头和结尾


![](document/public/imgs/demo-fix-evidence1.jpg)

![](document/public/imgs/demo-fix-evidence2.jpg)
...
原始路径：`/docs/use-cases/app-cases/google_search`
...
|                     |                       |
| --------------------- | --------------------- |
| 工具调用模式 ![](document/public/imgs/google_search_3.webp) | 工具调用模式 ![](document/public/imgs/google_search_4.webp) |
| 非工具调用模式 ![](document/public/imgs/google_search_1.webp) | 非工具调用模式 ![](document/public/imgs/google_search_2.webp) |
...
原始路径：`/docs/use-cases/app-cases/lab_appointment`
...
|                       |                       |
| --------------------- | --------------------- |
| ![](document/public/imgs/demo-appointment1.webp) | ![](document/public/imgs/demo-appointment2.webp) |
| ![](document/public/imgs/demo-appointment3.webp) | ![](document/public/imgs/demo-appointment4.webp) |
...
![](document/public/imgs/demo-appointment5.png)
...
![](document/public/imgs/demo-appointment6.jpg)
...
原始路径：`/docs/use-cases/app-cases/multi_turn_translation_bot`
...
![](document/public/imgs/translate1.png)
...
![](document/public/imgs/translate3.png)

在前文生成了初始翻译以及相应的反思后，将这二者输入给第三次 LLM 翻译，这样我们就能获得一个比较高质量的翻译结果

完整的工作流如下

![](document/public/imgs/translate4.png)
...
![](document/public/imgs/translate5.png)

![](document/public/imgs/translate61.png)

可以看到反思翻译后的效果还是好上不少的，其中反思的输出如下

![](document/public/imgs/translate7.png)
...
![](document/public/imgs/translate8.png)
...
![](document/public/imgs/translate9.png)
...
![](document/public/imgs/translate10.png)
...
![](document/public/imgs/translate11.png)

### 多文本块反思

![](document/public/imgs/translate12.png)

### 多文本块提升翻译

![](document/public/imgs/translate13.png)
...
![](document/public/imgs/translate14.png)

也就是通过判断当前处理的这个文本块，是否是最后一个文本块，从而判断是否需要继续执行，就这样，我们实现了长文反思翻译的效果

完整工作流如下

![](document/public/imgs/translate15.png)

## 运行效果

首先输入全局设置

![](document/public/imgs/translate16.png)
...
![](document/public/imgs/translate18.png)
...
![](document/public/imgs/translate19.png)

然后再让我们来看看运行效果

![](document/public/imgs/translate20.png)

给了和之前相同的一段文本进行测试，测试效果还是比较显著的，就比如红框部分，之前的翻译如下

![](document/public/imgs/translate21.png)
...
原始路径：`/docs/use-cases/app-cases/submit_application_template`
...
![](document/public/imgs/template_submission1.png)

1. ### 创建应用模板

应用模板配置以及相关资源，都会在 **packages/templates/src** 目录下。

![](document/public/imgs/template_submission2.png)
...
![](document/public/imgs/template_submission3.png)

1. ### 验证模板是否加载成功

刷新页面，打开模板市场，看其是否成功加载，并点击「使用」测试其功能。

![](document/public/imgs/template_submission4.png)
...
原始路径：`/docs/use-cases/app-cases/translate-subtitle-using-gpt`
...
![](document/public/imgs/extract-subtitle.png)
...
![](document/public/imgs/cut-text.png)
...
![](document/public/imgs/format-original-text.png)
...
1. 第一轮直译：要求 AI 严格按照 `` 标签逐句翻译，保证准确性。
   ...
   ![](document/public/imgs/ai-translate-1.png)

2. 第二轮意译：允许 AI 自主发挥，对第一轮的结果进行修改和优化。

3. 第三轮反思：AI 对自己的翻译进行评价，从多个角度提出改进建议。

   ![](document/public/imgs/ai-translate-2.png)

4. 最后一轮修改：根据反思阶段的建议，AI 对翻译进行最后的调整和优化。

   ![](document/public/imgs/ai-translate-3.png)
...
![](document/public/imgs/combine-subtitle.png)
...
![](document/public/imgs/loop-execution.png)
...
![](document/public/imgs/gpt-translate-example.png)
...
原始路径：`/docs/use-cases/external-integration/dingtalk`
...
![图片1](document/public/imgs/dingtalk-bot-1.png)

2. 获取**Client ID**和**Client Secret**。

![图片2](document/public/imgs/dingtalk-bot-2.png)
...
![图片3](document/public/imgs/dingtalk-bot-3.png)
...
![图片4](document/public/imgs/dingtalk-bot-4.png)

## 4. 配置机器人回调地址

点击左侧**机器人** 应用能力，然后将底部**消息接受模式**设置为**HTTP模式**，消息接收地址填入前面复制的 FastGPT 的回调地址。

![图片5](document/public/imgs/dingtalk-bot-5.png)
...
![图片6](document/public/imgs/dingtalk-bot-6.png)

点击**创建新版本**后，设置版本号和版本描述后点击保存发布即可。

![图片7](document/public/imgs/dingtalk-bot-7.png)

应用发布后，即可在钉钉企业中使用机器人功能，可对机器人私聊。或者在群组添加机器人后`@机器人`，触发对话。

![图片8](document/public/imgs/dingtalk-bot-8.png)
...
原始路径：`/docs/use-cases/external-integration/feishu`
...
![图片](document/public/imgs/feishu-bot-1.png)
...
| | | |
| --- | --- | --- |
| ![图片](document/public/imgs/feishu-bot-10.jpg) | ![图片](document/public/imgs/feishu-bot-11.jpg) | ![图片](document/public/imgs/feishu-bot-6.png) |
...
| | |
| --- | --- |
| ![图片](document/public/imgs/feishu-bot-7.png) | ![图片](document/public/imgs/feishu-bot-8.png) |
...
![](document/public/imgs/feishu-bot-13.jpg)

## 7. 发布机器人

点击飞书控制台左侧的`版本管理与发布`，即可发布机器人。

![](document/public/imgs/feishu-bot-12.jpg)

然后就可以在工作台里找到你的机器人啦。接下来就是把机器人拉进群组，或者单独与它对话。

![图片](document/public/imgs/feishu-bot-9.png)
...
原始路径：`/docs/use-cases/external-integration/official_account`
...
![图片](document/public/imgs/offiaccount-1.png)
...
![图片](document/public/imgs/offiaccount-2.png)

### 2. 把3个参数填入 FastGPT 配置弹窗中。

![图片](document/public/imgs/offiaccount-3.png)

## 3. 在 IP 白名单中加入 FastGPT 的 IP

![图片](document/public/imgs/offiaccount-4.png)
...
![图片](document/public/imgs/offiaccount-5.png)

![图片](document/public/imgs/offiaccount-6.png)
...
![图片](document/public/imgs/offiaccount-7.png)

2.  填入微信公众平台的 URL 处，然后提交保存

![图片](document/public/imgs/offiaccount-8.png)

## 6. 启用服务器配置（如已自动启用，请忽略）

![图片](document/public/imgs/offiaccount-9.png)
...
原始路径：`/docs/use-cases/external-integration/openapi`
...
![](document/public/imgs/fastgpt-api1.jpg)
...
![](document/public/imgs/chatgptnext.png)

**[ChatGPT Web](https://github.com/Chanzhaoyu/chatgpt-web) 示例：**

![](document/public/imgs/chatgptweb.png)

---

## 接入企微机器人教程

原始路径：`/docs/use-cases/external-integration/wecom`
...
![图片](document/public/imgs/wecom-bot-1.png)

在应用管理中找到"自建"-"创建应用"

![图片](document/public/imgs/wecom-bot-2.png)

创建好应用后, 下拉, 依次配置"网页授权及JS-SDK"和"企业可信IP"

![图片](document/public/imgs/wecom-bot-3.png)

其中, 网页授权及JS-SDK要求按照企微指引,完成域名归属认证

![图片](document/public/imgs/wecom-bot-4.png)

企业可信IP要求为企业服务器IP, 后续企微的回调URL将请求到此IP

![图片](document/public/imgs/wecom-bot-5.png)

## 2. 创建企业自建应用

前往 FastGPT ,选择想要接入的应用，在 发布渠道 页面，新建一个接入企微智能机器人的发布渠道，填写好基础信息。

![图片](document/public/imgs/wecom-bot-6.png)

现在回到企业微信平台,找到 Corp ID, Secret, Agent ID, Token, AES Key 信息并填写回 FastGPT 平台

![图片](document/public/imgs/wecom-bot-7.png)

在"我的企业"里找到企业 ID, 填写到 FastGPT 的 Corp ID 中

![图片](document/public/imgs/wecom-bot-8.png)

在应用中找到 Agent Id 和 Secret, 并填写回 FastGPT

![图片](document/public/imgs/wecom-bot-9.png)

点击"消息接收"-"设置API接收"

![图片](document/public/imgs/wecom-bot-10.png)

随机生成或者手动输入 Token 和 Encoding-Key, 分别填写到 FastGPT 的 Token 和 AES Key 中

![图片](document/public/imgs/wecom-bot-11.png)

填写完成后确认创建

然后点击请求地址, 复制页面中的链接

![图片](document/public/imgs/wecom-bot-12.png)
...
![图片](document/public/imgs/wecom-bot-13.png)

创建机器人页面,下拉,找到,点击"API模式创建"

![图片](document/public/imgs/wecom-bot-14.png)

与刚才配置自建应用同理, 在 FastGPT 平台再新增一个发布渠道, 并回到企业微信配置参数

![图片](document/public/imgs/wecom-bot-19.png)

随机生成或者手动输入 Token 和 Encoding-AESKey, 分别填写到 FastGPT 的 Token 和 AES Key 中

![图片](document/public/imgs/wecom-bot-15.png)
...
![图片](document/public/imgs/wecom-bot-16.png)

复制 Bot ID, 填写到 FastGPT 的 Agent ID 中, 即可完成智能机器人配置

![图片](document/public/imgs/wecom-bot-17.png)

## 4. 使用智能机器人

在企业微信平台的"通讯录",即可找到创建的机器人,就可以发送消息了

![图片](document/public/imgs/wecom-bot-18.png)
